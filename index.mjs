...
program
  .description('Create 2 component image from 2 images')
  .arguments('<inputFile1> <inputFile2> <outputFile>')
  .parse(process.argv)
...
const pipelinePath = path.resolve('./emscripten-build/VectorImageTest')
